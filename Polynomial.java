...
public class Polynomial 
{
	...
	{	
		...
		int index=0;
		if(t.getCoefficient().equals(0) || exponent<0) {
		throw new IllegalArgumentException("The coefficient cannot be 0 and the exponent cannot be negative");
		}
		for(Term term : polynomial) {
			if(exponent<term.getExponent()) {
				index++
				continue;
			}
